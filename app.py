...
def upload():
    ...
    if request.method == "POST":
        ...
        path={'executable_path': 'C:\\Users\\mandeep.singh\\Youtube\\Youtube\\ML\\End-To-End-Projects\\ReciepeRecognizer\\chrome-win64\\chrome.exe'}
        chrome_driver_path='C:\\Users\\mandeep.singh\\Youtube\\Youtube\\ML\\End-To-End-Projects\\ReciepeRecognizer\\chrome-win64\\chrome.exe'
        ...
        if data=="tuna tartare":
            ...
            html=browser.html
            soup=BeautifulSoup(html,"html.parser")
            var=soup.select_one('div#mw-content-text.mw-body-content.mw-content-ltr div.mw-parser-output')
            description=var.select('p')
